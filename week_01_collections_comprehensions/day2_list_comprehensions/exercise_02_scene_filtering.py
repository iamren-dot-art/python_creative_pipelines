...
polycount_1000 = [
    obj["name"] for obj in scene if obj["type"] == "mesh" and obj["poly_count"] > 999
]
print(polycount_1000)

# 5. Get total poly count of all visible meshes (hint: sum() works on lists)
polycount_visible = [obj["poly_count"] for obj in scene if obj["visible"]]
total_poly = sum(polycount_visible)
print(total_poly)
